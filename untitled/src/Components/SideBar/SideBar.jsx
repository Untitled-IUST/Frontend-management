      ...
      <div id="app" style={({ height: "100vh" }, { display: "flex" })}>
        <Sidebar backgroundColor="#261B39"  style={{ height: "100vh" }} >
          <Menu rootStyles={{color: "#fecbca"}} >
            ...
            <MenuItem icon={<StorefrontIcon/>} component={<Link to="/AddService" />}>Profile</MenuItem>
            <MenuItem icon={<ManageHistoryIcon/>} component={<Link to="/OrderHistory" />}>Hairdresser</MenuItem>
            <MenuItem icon={<LogoutIcon />} onClick={() => {localStorage.removeItem('accessTokenBarber')}} component={<Link to="/login" />}>Log Out</MenuItem>
          </Menu>
        </Sidebar>
      </div>
    )
